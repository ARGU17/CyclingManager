/* ============================================================
   ...
   v0.5: temporada, carreras, equipos/corredores reales,
   objetivos, UCI, perfiles, entrenamientos, dificultad.
   ============================================================ */

const TEAM_BLUEPRINTS = [
  { id: "uae", name: "UAE Team Emirates XRG", archetype: "GC / Superteam", description: "Equipo dominante de grandes vueltas, montaña, cronos y clásicas.", color: "green", management: { budget: 42000000, prestige: 96, sponsorPressure: 94 }, objectives: ["gc_win", "stage_wins_3", "uci_top_1"], modifiers: { flat: 3, sprint: 1, timeTrial: 5, teamTimeTrial: 5, mountain: 7, cobbles: 1, hills: 5, stamina: 6, recovery: 6, acceleration: 5, positioning: 5, downhill: 3, form: 4 } },
  { id: "visma", name: "Team Visma | Lease a Bike", archetype: "GC / Bloque", description: "Bloque de gran vuelta muy fuerte en montaña, recuperación y trabajo colectivo.", color: "yellow", management: { budget: 38000000, prestige: 94, sponsorPressure: 92 }, objectives: ["gc_win", "teams_win", "stage_wins_2"], modifiers: { flat: 2, sprint: 1, timeTrial: 4, teamTimeTrial: 6, mountain: 6, cobbles: 2, hills: 4, stamina: 6, recovery: 7, acceleration: 3, positioning: 6, downhill: 4, form: 3 } },
  { id: "ineos", name: "Netcompany INEOS", archetype: "Crono / GC", description: "Equipo orientado a cronos, rodadores, ciencia deportiva y líderes de general.", color: "blue", management: { budget: 35000000, prestige: 89, sponsorPressure: 86 }, objectives: ["gc_top_3", "stage_win", "uci_top_3"], modifiers: { flat: 4, sprint: -1, timeTrial: 8, teamTimeTrial: 8, mountain: 3, cobbles: 1, hills: 2, stamina: 5, recovery: 4, acceleration: 0, positioning: 4, downhill: 2, form: 2 } },
  { id: "movistar", name: "Movistar Team", archetype: "Montaña / Etapas", description: "Equipo español con foco en montaña, fugas, general y etapas selectivas.", color: "blue", management: { budget: 17000000, prestige: 78, sponsorPressure: 75 }, objectives: ["gc_top_5", "stage_win", "mountain_top_3"], modifiers: { flat: 0, sprint: -2, timeTrial: 1, teamTimeTrial: 1, mountain: 5, cobbles: -2, hills: 4, stamina: 4, recovery: 4, acceleration: 2, positioning: 2, downhill: 3, form: 2 } },
  { id: "redbull", name: "Red Bull - BORA - hansgrohe", archetype: "GC / Potencia", description: "Equipo muy fuerte en líderes de general, montaña y potencia sostenida.", color: "orange", management: { budget: 33000000, prestige: 90, sponsorPressure: 88 }, objectives: ["gc_top_3", "stage_wins_2", "uci_top_3"], modifiers: { flat: 2, sprint: 1, timeTrial: 4, teamTimeTrial: 4, mountain: 6, cobbles: 0, hills: 3, stamina: 5, recovery: 5, acceleration: 3, positioning: 3, downhill: 2, form: 3 } },
  { id: "soudal", name: "Soudal Quick-Step", archetype: "Crono / Sprint", description: "Equipo muy fuerte en cronos, velocidad, etapas llanas y talento ofensivo.", color: "blue", management: { budget: 28000000, prestige: 87, sponsorPressure: 84 }, objectives: ["gc_top_3", "points_top_3", "time_trial_win"], modifiers: { flat: 4, sprint: 5, timeTrial: 7, teamTimeTrial: 5, mountain: 1, cobbles: 3, hills: 3, stamina: 3, recovery: 2, acceleration: 5, positioning: 4, downhill: 1, form: 2 } },
  { id: "lidl", name: "Lidl - Trek", archetype: "Clásicas / Sprint / GC", description: "Equipo completo: clásicas, sprint, montaña y corredores de general.", color: "red", management: { budget: 29000000, prestige: 86, sponsorPressure: 82 }, objectives: ["stage_wins_2", "points_top_3", "uci_top_5"], modifiers: { flat: 4, sprint: 6, timeTrial: 3, teamTimeTrial: 3, mountain: 4, cobbles: 5, hills: 5, stamina: 4, recovery: 3, acceleration: 5, positioning: 4, downhill: 3, form: 3 } },
  { id: "alpecin", name: "Alpecin - Premier Tech", archetype: "Clásicas / Sprint", description: "Clasicómanos y velocistas; brutal en pavés, muros y finales explosivos.", color: "orange", management: { budget: 24000000, prestige: 88, sponsorPressure: 83 }, objectives: ["points_win", "stage_wins_3", "monument_win"], modifiers: { flat: 5, sprint: 8, timeTrial: 0, teamTimeTrial: 1, mountain: -4, cobbles: 9, hills: 7, stamina: 4, recovery: 0, acceleration: 8, positioning: 7, downhill: 3, form: 3 } },
  { id: "bahrain", name: "Bahrain Victorious", archetype: "Montaña / Clásicas", description: "Equipo equilibrado con escaladores, clasicómanos y cazadores de etapa.", color: "red", management: { budget: 22000000, prestige: 80, sponsorPressure: 77 }, objectives: ["stage_win", "gc_top_10", "mountain_top_3"], modifiers: { flat: 2, sprint: 2, timeTrial: 2, teamTimeTrial: 2, mountain: 4, cobbles: 3, hills: 5, stamina: 4, recovery: 3, acceleration: 4, positioning: 3, downhill: 4, form: 2 } },
  { id: "decathlon", name: "Decathlon CMA CGM Team", archetype: "Montaña / Desarrollo", description: "Escaladores, jóvenes talentos y buen rendimiento en media montaña.", color: "green", management: { budget: 21000000, prestige: 79, sponsorPressure: 74 }, objectives: ["youth_win", "stage_win", "gc_top_10"], modifiers: { flat: 0, sprint: 1, timeTrial: 1, teamTimeTrial: 1, mountain: 5, cobbles: 0, hills: 5, stamina: 4, recovery: 3, acceleration: 4, positioning: 2, downhill: 3, form: 3 } }
];
...
const ROLE_TEMPLATES = {
  gc: { role: "Líder GC", ageBase: 28, abandonRisk: 0.016, stats: { flat: 80, sprint: 66, timeTrial: 84, teamTimeTrial: 84, mountain: 88, cobbles: 68, hills: 84, stamina: 90, recovery: 89, acceleration: 80, positioning: 84, downhill: 82, consistency: 88, injuryResistance: 82 }, form: 84 },
  co_leader: { role: "Co-líder", ageBase: 27, abandonRisk: 0.018, stats: { flat: 78, sprint: 64, timeTrial: 80, teamTimeTrial: 81, mountain: 85, cobbles: 66, hills: 82, stamina: 87, recovery: 86, acceleration: 78, positioning: 80, downhill: 80, consistency: 84, injuryResistance: 81 }, form: 82 },
  climber: { role: "Escalador", ageBase: 27, abandonRisk: 0.021, stats: { flat: 72, sprint: 58, timeTrial: 72, teamTimeTrial: 74, mountain: 87, cobbles: 56, hills: 81, stamina: 86, recovery: 85, acceleration: 78, positioning: 76, downhill: 80, consistency: 82, injuryResistance: 78 }, form: 81 },
  time_trialist: { role: "Croner", ageBase: 28, abandonRisk: 0.017, stats: { flat: 84, sprint: 64, timeTrial: 86, teamTimeTrial: 87, mountain: 74, cobbles: 68, hills: 75, stamina: 84, recovery: 81, acceleration: 70, positioning: 78, downhill: 76, consistency: 84, injuryResistance: 80 }, form: 81 },
  sprinter: { role: "Sprinter", ageBase: 29, abandonRisk: 0.026, stats: { flat: 84, sprint: 88, timeTrial: 70, teamTimeTrial: 76, mountain: 62, cobbles: 72, hills: 72, stamina: 80, recovery: 76, acceleration: 89, positioning: 86, downhill: 74, consistency: 78, injuryResistance: 75 }, form: 81 },
  classics: { role: "Clasicómano", ageBase: 29, abandonRisk: 0.024, stats: { flat: 82, sprint: 78, timeTrial: 75, teamTimeTrial: 78, mountain: 72, cobbles: 83, hills: 84, stamina: 84, recovery: 80, acceleration: 84, positioning: 87, downhill: 80, consistency: 80, injuryResistance: 77 }, form: 81 },
  rouleur: { role: "Rodador", ageBase: 29, abandonRisk: 0.018, stats: { flat: 85, sprint: 70, timeTrial: 80, teamTimeTrial: 83, mountain: 72, cobbles: 72, hills: 75, stamina: 83, recovery: 80, acceleration: 72, positioning: 79, downhill: 76, consistency: 82, injuryResistance: 82 }, form: 79 },
  domestique: { role: "Gregario", ageBase: 29, abandonRisk: 0.019, stats: { flat: 78, sprint: 66, timeTrial: 75, teamTimeTrial: 78, mountain: 78, cobbles: 66, hills: 77, stamina: 82, recovery: 81, acceleration: 73, positioning: 78, downhill: 76, consistency: 80, injuryResistance: 82 }, form: 78 },
  puncheur: { role: "Puncheur", ageBase: 26, abandonRisk: 0.023, stats: { flat: 78, sprint: 76, timeTrial: 74, teamTimeTrial: 76, mountain: 78, cobbles: 72, hills: 86, stamina: 83, recovery: 80, acceleration: 86, positioning: 82, downhill: 80, consistency: 78, injuryResistance: 77 }, form: 81 }
};
...
function deterministicNoise(teamIndex, riderIndex, statName) {
  const seed =
    teamIndex * 97 +
    riderIndex * 31 +
    statName.split("").reduce((s, c) => s + c.charCodeAt(0), 0);

  const raw = Math.sin(seed) * 10000;
  return Math.round(((raw - Math.floor(raw)) - 0.5) * 6);
}
...
function buildStats(baseStats, modifiers, teamIndex, riderIndex) {
  ...
  Object.keys(baseStats).forEach(k => {
    stats[k] = dataClamp(
      baseStats[k] + (modifiers[k] || 0) + deterministicNoise(teamIndex, riderIndex, k),
      42,
      99
    );
  });
...
const TRAINING_OPTIONS = [
  ...
  },
  {
    ...
    description: "Mejora CRI/CRE, útil antes de vueltas con cronos.",
...
const TOUR_STAGES = [
  ...
  stage("tour", 2, "Tour 2 - Muros del Interior", "hilly", 171, 68, {
    ...
    description: "Final quebrado con repechos y bonificaciones."
  }),
  stage("tour", 3, "Tour 3 - Llanura del Norte", "flat", 198, 38, {
    elevationGain: 700,
    windExposure: 45,
    description: "Día largo para sprinters."
  }),
  stage("tour", 4, "Tour 4 - Crono por Equipos", "team_time_trial", 41, 62, {
    elevationGain: 400,
    intermediateSprints: false,
    finishBonuses: false,
  ...
  stage("tour", 5, "Tour 5 - Pavés y Muros", "cobbles_hills", 204, 88, {
    ...
    description: "Pavés, muros, colocación y riesgo alto."
  }),
  ...
  stage("tour", 7, "Tour 7 - Primer Contacto Alpino", "mountain", 164, 84, {
    ...
    finalClimb: true,
    description: "Primera etapa de montaña."
  }),
  ...
  stage("tour", 12, "Tour 12 - Camino de los Viñedos", "flat", 211, 42, {
    elevationGain: 1100,
    heat: 65,
    description: "Etapa larga y calurosa."
  }),
  stage("tour", 13, "Tour 13 - Colinas Encadenadas", "hilly", 194, 76, {
    ...
    description: "Jornada favorable a la fuga."
  }),
  stage("tour", 14, "Tour 14 - Etapa Reina", "mountain", 178, 98, {
    ...
    finalClimb: true,
    description: "Día más duro de la carrera."
  }),
  ...
  stage("tour", 17, "Tour 17 - Alta Montaña Explosiva", "mountain", 136, 90, {
    ...
    finalClimb: true,
    description: "Etapa corta para ataques."
  }),
  ...
  stage("tour", 21, "Tour 21 - Paseo Final", "flat", 115, 25, {
    elevationGain: 400,
    description: "Etapa final y sprint probable."
  })
];
...
const ONE_DAY_RACES = [
  {
    ...
    stages: [
      stage("roubaix", 1, "Paris-Roubaix", "cobbles_hills", 257, 98, {
        ...
        windExposure: 55,
        climbs: [
          climb("Trouée d'Arenberg", "2", 162, 2.3, 2.0),
          climb("Carrefour de l'Arbre", "2", 240, 2.1, 2.0)
        ],
  ...
  },
  {
    ...
    stages: [
      stage("flanders", 1, "Tour de Flandes", "cobbles_hills", 272, 96, {
        ...
        windExposure: 50,
        climbs: [
          climb("Oude Kwaremont", "2", 220, 2.2, 4.0),
          climb("Paterberg", "2", 247, 0.4, 12.9)
        ],
  ...
  },
  {
    ...
    stages: [
      stage("liege", 1, "Liège-Bastogne-Liège", "hilly", 259, 94, {
        elevationGain: 4100,
        climbs: [
          climb("La Redoute", "1", 220, 2.0, 8.9),
          climb("Roche-aux-Faucons", "1", 242, 1.3, 11.0)
        ],
  ...
  },
  {
    ...
    stages: [
      stage("lombardia", 1, "Il Lombardia", "hilly", 253, 95, {
        ...
        technicalDescent: 75,
        climbs: [
          climb("Madonna del Ghisallo", "1", 166, 8.6, 6.2),
          climb("Civiglio", "1", 235, 4.2, 9.7)
        ],
  ...
  },
  {
    ...
    stages: [
      stage("worlds", 1, "Mundial en ruta", "hilly", 268, 97, {
        elevationGain: 3600,
        climbs: [
          climb("Circuito duro", "2", 210, 3.1, 7.8),
          climb("Último muro", "3", 263, 1.0, 9.5)
        ],
...
const SMART_PRESETS = [
  {
    id: "protect_gc",
    name: "Proteger GC",
    description: "Líder equilibrado; gregarios protegen."
  },
  {
    id: "sprint",
    name: "Sprint masivo",
    description: "Sprinter ataca; rodadores hacen tren."
  },
  {
    id: "breakaway",
    name: "Fuga del día",
    description: "Puncheurs/rouleurs atacan; líderes conservan."
  },
  {
    id: "mountain_attack",
    name: "Montaña agresiva",
    description: "GC y escaladores atacan; gregarios protegen."
  },
  {
    id: "survival",
    name: "Supervivencia",
    description: "Todos conservan para salvar fatiga."
  },
  {
    id: "time_trial",
    name: "Crono a tope",
    description: "Croners y líderes atacan; resto equilibrado."
  }
];
